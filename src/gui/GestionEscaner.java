...
public class GestionEscaner extends JPanel {
	...
	public GestionEscaner() {
		...
		JLabel lblIntroduceLaIp = new JLabel("Introduce la ip de la m�quina del cliente:");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if(!ruta.equals("\\tarea.bat") && !ruta.equals("")) {
						...
						JOptionPane.showMessageDialog(null, "La ejecuci�n se realiz� con �xito");
					}
					else {
						JOptionPane.showMessageDialog(null, "No se ha encontrado el archivo "+(char)34+"tarea.bat"+(char)34+" revise la configuraci�n");
					}
			...
			if(!ruta.equals("\\revisor.bat") && !rutaOrigen.equals("") && !rutaDestino.equals("")) {
				...
				if(rdbtnNo.isSelected()){
					...
					if(!textField_IP.getText().trim().equals("")) {
						...
						JOptionPane.showMessageDialog(null, "El campo ip no puede estar vac�o");
					}
				}
				...
				if(ruta.equals("\\revisor.bat")) {
					JOptionPane.showMessageDialog(null, "No se ha encontrado el directorio para el archivo "+(char)34+"revisor.bat"+(char)34+" revise la configuraci�n");
				}
				else {
...
//		System.out.println(archivoCnfg.getAbsoluteFile());
		...
		try {
			if(!ruta.equals("\\cnfg.vbs")) {
				...
				JOptionPane.showMessageDialog(null, "No se ha encontrado el directorio para el archivo "+(char)34+"cnfg.vbs"+(char)34+" revise la configuraci�n");
			}
...
//		System.out.println(archivoTarea.getAbsoluteFile());
		...
		try {
			if(!ruta.equals("\\tarea.bat")) {
				...
				JOptionPane.showMessageDialog(null, "No se ha encontrado el directorio para el archivo "+(char)34+"tarea.bat"+(char)34+" revise la configuraci�n");
			}
